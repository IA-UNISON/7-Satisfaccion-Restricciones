...
if __name__ == "__main__":
    ...
    """
    Hace muchos backtrakings pero es mas rapido que la consistencia tipo 2
    ya que hace muchas menos revisiones de los vecinos y encuentra una solucion
    mas directa (a la fuerza bruta, prueba y error)
    """
    ...
    """
    Utiliza mucho menos backtrakings pero a partir de las 50 reinas se 
    empieza a notar la diferencia en los tiempos en comparacion de la 
    arco consistencia tipo 1
    """
    ...
    """
    Para apartir de 101 reinas empieza a tardar demaciado y 1000 ni se diga!
    """
