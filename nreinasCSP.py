...
if __name__ == "__main__":
    ...
    t_inicial = time.time()
    prueba_reinas(4, csp.asignacion_grafo_restriccion, traza=False, tipo=1)
    prueba_reinas(8, csp.asignacion_grafo_restriccion, traza=False, tipo=1)
    prueba_reinas(16, csp.asignacion_grafo_restriccion, traza=False, tipo=1)
    prueba_reinas(50, csp.asignacion_grafo_restriccion, tipo=1)
    prueba_reinas(101, csp.asignacion_grafo_restriccion, tipo=1)
    t_final = time.time()
    print("Tiempo de ejecución con consistencia 1 en segundos: {}".format(t_final - t_inicial))
    
    # Utilizando consistencia
    # ==========================================================================
    # Probar y comentar los resultados del métdo de arco consistencia
    # 
    # El tiempo de ejecución es mucho mayor, pero si teduce el numero de backtracings
    # Dnando como resultado 4 backtrackings en 101 reinas
    # ==========================================================================
    t_inicial = time.time()
    prueba_reinas(4, csp.asignacion_grafo_restriccion, traza=False, tipo=2)
    prueba_reinas(8, csp.asignacion_grafo_restriccion, traza=False, tipo=2)
    prueba_reinas(16, csp.asignacion_grafo_restriccion, traza=False, tipo=2)
    prueba_reinas(50, csp.asignacion_grafo_restriccion, tipo=2)
    prueba_reinas(101, csp.asignacion_grafo_restriccion, tipo=2)
    t_final = time.time()
    print("Tiempo de ejecución con arco consistencia en segundos: {}".format(t_final - t_inicial))
    # Utilizando minimos conflictos
    # ==========================================================================
    # Probar y comentar los resultados del métdo de mínios conflictos
    #
    # El tiempo es mucho menor que en arco consistencias y sin backtrackings
    #
    # ==========================================================================
    t_inicial = time.time()
    ...
    prueba_reinas(50, csp.min_conflictos, tipo=3)
    prueba_reinas(101, csp.min_conflictos, tipo=3)
    t_final = time.time()
    print("Tiempo de ejecución con minimos conflictos en segundos: {}".format(t_final - t_inicial))
